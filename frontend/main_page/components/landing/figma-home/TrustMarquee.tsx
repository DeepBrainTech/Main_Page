...
export default function TrustMarquee() {
  ...
  const items = [
    { icon: "/landing/hero/union-icon.svg", width: 32, height: 28, text: t("trustFounded") },
    { icon: "/landing/hero/Subtract.svg", width: 34, height: 34, text: t("trustClassrooms") },
  ];
  ...
  return (
    <section className="mx-auto mt-[clamp(2.5rem,4.1667vw,5rem)] h-20 w-full max-w-[120rem] overflow-hidden bg-[#1a1a1a]" aria-label={t("trustStripLabel")}>
